...
class UserService extends BaseService
{
    ...
    public function create(array $data): mixed
    {
        ...
        $this->saveAddressAndPermissions($user, $data);
    ...
    private function saveAddressAndPermissions($user, $data): void
    {
        ...
        // Sincronizar permissões se existirem
    ...
    public function delete(int $id): void
    {
        ...
        // Deletar usuário (cascade deletará endereço e permissões)
        $user->delete();
    }
